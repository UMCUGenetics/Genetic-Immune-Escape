...
l=[]
for report in tqdm(glob.glob("/hpc/cuppen/projects/P0020_genetics_immune_escape/large_scale_primary_met/processed/pcawg/hla_events/*/report_background_genes/genomic_alterations.tsv.gz")):
