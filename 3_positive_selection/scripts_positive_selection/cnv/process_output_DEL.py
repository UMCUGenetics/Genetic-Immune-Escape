...
def plot_ttype(res,annotations_info, i, ttype, list_chunks, output_dir_plots,name_run):
    ...
    #ax.set_ylim(-1,100) # for visualization
...
def run(chunks_representation, input_directory):
    ...
    highlight_genes_general = ['HLA-A', 'HLA-B', 'HLA-C', 'TAP1', 'TAP2', 'TAPBP', 'B2M', 'CALR',  'JAK1', 'JAK2', 'STAT1', 'IRF2',  'IFNGR1', 'IFNGR2', 'NLRC5', 'RFX5', 'CIITA', 'CD58']
